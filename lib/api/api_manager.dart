...
import 'package:e_commerce_app/api/data/model/response/category/subcategory_dto.dart';
...
abstract class ApiManager {
  ...
  @GET("${EndPoints.categoriesApi}/{categoryId}/${EndPoints.subCategoriesApi}")
  Future<SubcategoryResponseDto> getSubcategories(@Path("categoryId") String categoryId);
